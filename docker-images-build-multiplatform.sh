...
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.0.30.1-production . -f production.Dockerfile --push
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.0.30.1-development . -f development.Dockerfile --push

cd ~/misc/apps/docker_infrastructure/templates/php/8.1/ || exit
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.1.34-production . -f production.Dockerfile --push
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.1.34-development . -f development.Dockerfile --push

cd ~/misc/apps/docker_infrastructure/templates/php/8.2/ || exit
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.2.30-production . -f production.Dockerfile --push
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.2.30-development . -f development.Dockerfile --push

cd ~/misc/apps/docker_infrastructure/templates/php/8.3/ || exit
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.3.30-production . -f production.Dockerfile --push
docker buildx build --platform linux/amd64,linux/arm64,linux/arm64/v8 -t defaultvalue/php:8.3.30-development . -f development.Dockerfile --push
