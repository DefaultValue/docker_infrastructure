FROM php:7.2.34-apache-buster@sha256:4dc0f0115acf8c2f0df69295ae822e49f5ad5fe849725847f15aa0e5802b55f8
...
RUN docker-php-ext-install gd intl mysqli opcache pcntl pdo_mysql soap xml xmlrpc xsl zip bcmath sodium recode sockets
